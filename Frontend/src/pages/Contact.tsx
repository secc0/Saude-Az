          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-700">
                Estamos à disposição para esclarecer suas dúvidas e ajudar sua empresa 
                a oferecer os melhores benefícios de saúde.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="flex flex-col justify-between">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          contato@healthplus.com.br
                          <br />
                          suporte@healthplus.com.br
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-12 p-6 bg-health-50 rounded-xl border border-health-100">
                  ...
                  <p className="text-slate-700 mb-4">
                    Já é cliente? Entre em contato com nosso suporte dedicado para um atendimento mais rápido.
                  </p>
            ...
            <div className="h-96 bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
              ...
              <div className="h-full w-full flex items-center justify-center bg-slate-200">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">Mapa do escritório da HealthPlus</p>
                </div>
              </div>
            </div>
          </div>
