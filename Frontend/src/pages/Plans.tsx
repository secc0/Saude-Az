  ...
  const plans = [
    {
      ...
      description:
        "O plano ideal para colaboradores individuais com cobertura ampla",
      features: [
    ...
    },
    {
      ...
      priceDescription: "por cartão/mês",
      description:
        "Serviços essenciais de saúde para colaboradores individuais",
      features: [
        "Rede TEM Individual com 2 consultas gratuitas por ano",
    ...
    },
    {
      ...
      priceDescription: "por cartão/mês",
      description:
        "Acesso básico à telemedicina e consultas para colaboradores",
      features: [
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-700 mb-6">
                Escolha o plano ideal para sua empresa e proporcione saúde
                complementar acessível para seus colaboradores
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {plans.map((plan) => (
                ...
                >
                  <CardHeader
                    className={`${plan.highlight ? "bg-health-50" : ""}`}
                  >
            ...
            <div className="mt-16 bg-white p-8 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-700 mb-6">
                Todos os planos do Clube AZ incluem acesso via celular e
                computador, com login exclusivo para acompanhamento de uso e
                dados de saúde. Seus colaboradores terão todas as informações na
                palma da mão.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-700">
                    Nosso aplicativo permite que seus colaboradores agendem
                    consultas, acessem telemedicina, visualizem histórico médico
                    e obtenham descontos em medicamentos, tudo em um só lugar.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container-custom">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl">
                Contrate agora um de nossos planos e proporcione aos seus
                colaboradores acesso a serviços de saúde de qualidade com preços
                acessíveis.
              </p>
