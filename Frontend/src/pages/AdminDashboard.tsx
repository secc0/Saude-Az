...
const AdminDashboard = () => {
  ...
  const totalEmployees = companies.reduce(
    (acc, company) => acc + company.employeesCount,
    0
  );
        ...
        <Tabs defaultValue="overview" className="w-full">
                  ...
                  <div className="h-80 bg-slate-50 rounded-md flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 text-sm">
                        (Os dados reais seriam exibidos em um gráfico de pizza
                        aqui)
                      </p>
                    </div>
                  </div>
                ...
                <CardContent>
                  <div className="h-80 bg-slate-50 rounded-md flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 text-sm">
                        (Os dados reais seriam exibidos em um gráfico de linha
                        aqui)
                      </p>
                    </div>
                  </div>
          ...
          <TabsContent value="employees" className="space-y-6">
            <Card>
              ...
              <CardFooter className="flex justify-between">
                <p className="text-sm text-slate-500">
                  Mostrando 4 de 100 colaboradores
                </p>
                <div className="flex space-x-2">
                  <Button variant="outline" size="sm" disabled>
                    Anterior
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="border border-slate-200 rounded-lg p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      Lista completa de todos os colaboradores por empresa.
                    </p>
                    <Button onClick={handleGenerateReport}>
                      <Download className="h-4 w-4 mr-2" /> Gerar Relatório
                    </Button>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      Exporte múltiplos relatórios de uma vez
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-slate-600 mb-4">
                      Selecione os relatórios que deseja exportar e o formato de
                      saída (PDF ou Excel).
                    </p>
